...
use Riclep\Storyblok\xStoryblok;

class xTestCase extends Orchestra
{
	...
	protected function mockPage($type = 'Default') {
		$storyblokMock = $this->getMockBuilder(xStoryblok::class, ['requestStory'])->setMethods(['requestStory'])->getMock();
